...
class UtilTest < ActiveSupport::TestCase
  ...
  test 'authorized types' do
    # How to enable Placeholder?
    expected = [Assay, Collection, DataFile, Document, Event, FileTemplate, Investigation, Model, Placeholder, Presentation, Publication, Sample, Sop, Strain, Study, Workflow, Template, SampleType].map(&:name).sort
